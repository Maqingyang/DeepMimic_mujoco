...
# CUDA_VISIBLE_DEVICES=4 mpirun -np 10 python3 gail_ppo_PID_unnorm_speed.py --config config/gail_ppo_biped_PID_unnorm_speed.yaml
CUDA_VISIBLE_DEVICES=2 mpirun -np 10 python3 gail_ppo_PID_unnorm.py --config config/gail_ppo_biped_PID_unnorm.yaml
