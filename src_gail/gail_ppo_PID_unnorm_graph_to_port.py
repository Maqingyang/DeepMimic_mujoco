...
from discriminator_transition_GP_graph_to_port import GraphDiscriminator
...
def main(args):
    ...
    if args.task == 'train':
        ...
        connections=[(6,5),(5,4),(4,0),(0,1),(1,2),(2,3)]
        # Build disc
        reward_giver = GraphDiscriminator(C.adversary_hidden_size, num_node, lookup_table, connections, entcoeff=C.adversary_entcoeff, logits_regular_coeff=C.logits_regular_coeff)
