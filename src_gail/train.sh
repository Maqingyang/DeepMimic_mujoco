...
# CUDA_VISIBLE_DEVICES=9 mpirun -np 10 python3 gail_ppo_PID_unnorm_graph.py --config config/gail_ppo_PID_unnorm_graph.yaml
# CUDA_VISIBLE_DEVICES=9 mpirun -np 10 python3 gail_ppo_PID_unnorm_graph.py --config config/gail_ppo_PID_unnorm_graph-no_logits_reg.yaml
CUDA_VISIBLE_DEVICES=9 mpirun -np 10 python3 gail_ppo_PID_unnorm_graph_to_port.py --config config/gail_ppo_PID_unnorm_graph_to_port.yaml
