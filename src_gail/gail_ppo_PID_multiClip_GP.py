...
from cg import cg
from discriminator_transition_GP import Discriminator
...
def main(args):
    ...
    if args.task == 'train':
        ...
        transition_length = pos_len * 2 # shape of ob + act = shape of ob + next_ob
        reward_giver = Discriminator(transition_length, C.adversary_hidden_size, entcoeff=C.adversary_entcoeff)
